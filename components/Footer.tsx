...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-white/40 bg-white/70 py-6 text-sm text-slate-500 backdrop-blur dark:border-slate-800/70 dark:bg-slate-950/70 dark:text-slate-300">
